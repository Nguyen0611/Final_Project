...
public class DateUtil {
    ...
    public static String getDateToString(){
        ...
        ZonedDateTime zonedDateTime = ZonedDateTime.of(localDateTime, ZoneId.of("GMT+7"));
        DateTimeFormatter formatter2 = DateTimeFormatter.ofPattern("ddMMyyyy");
        return zonedDateTime.format(formatter2);
    }

    public static ZonedDateTime getDateC(){
        LocalDateTime localDateTime = LocalDateTime.now();
        ZonedDateTime zonedDateTime = ZonedDateTime.of(localDateTime, ZoneId.of("GMT+7"));
        DateTimeFormatter formatter2 = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss");
        String formattedString2 = zonedDateTime.format(formatter2);
        ZonedDateTime date = FunctionCommon.getDateTime(formattedString2, "dd/MM/yyyy HH:mm:ss");
        return date;
    }
    ...
    private static String TIMETEMP_FORMAT = "yyyyMMddHHmm";
    ...
    public static ZonedDateTime getDateTime(String value) {
        try {
            DateTimeFormatter formatter = DateTimeFormatter.ofPattern(TIMETEMP_FORMAT);
            LocalDate date = LocalDate.parse(value, formatter);
            return date.atStartOfDay(ZoneId.systemDefault());
        } catch (Exception e) {
            return null;
    ...
    public static String getDateTimeStr(ZonedDateTime zonedDateTime, String format) {
        try {
            DateTimeFormatter formatter = DateTimeFormatter.ofPattern(format);
    ...
    public static String getDateTimeStr(ZonedDateTime zonedDateTime) {
        try {
            DateTimeFormatter formatter = DateTimeFormatter.ofPattern(TIMETEMP_FORMAT);
            return zonedDateTime.format(formatter);
        } catch (Exception e) {
    ...
    public static String getDateStr(LocalDate zonedDateTime, String format) {
        try {
            DateTimeFormatter formatter = DateTimeFormatter.ofPattern(format);
            return zonedDateTime.format(formatter);
        } catch (Exception e) {
    ...
    public static String getDateStr(LocalDate zonedDateTime) {
        try {
    ...
    public static boolean checkDateInMonth(String startDate, String endDate) {
        try {
            LocalDate localStartDate = getDate(startDate);
            LocalDate localEndDate = getDate(endDate);
            if (localStartDate != null && localEndDate != null) {
                return localStartDate.getMonthValue() == localEndDate.getMonthValue()
                    && localStartDate.getYear() == localEndDate.getYear();
            }
            return false;
        } catch (Exception e) {
            return false;
